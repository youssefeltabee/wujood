    ...
    <>
      ...
      <main className="px-4 py-16 max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
          ...
          <p>نستخدم معلوماتك لتشغيل المنصة، تحسين خدماتنا، إرسال تحديثات، ودعم عملائنا. لن نشارك معلوماتك مع أطراف ثالثة إلا للضرورة القانونية أو التقنية.</n>م نستخدم تشفير SSL لحماية بياناتك، ونتخذ إجراءات أمنية مشددة.</p>
        </div>
      </main>
      <Footer />
    </>
